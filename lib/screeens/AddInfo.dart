      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('NAME:', style: TextStyle(color: Colors.purple.shade300),),
            _isEditing
                ? TextField(
            ...
            SizedBox(height: 16.0),
            Text('EMAIL:',style: TextStyle(color: Colors.purple.shade300),),
            _isEditing
                ? TextField(
            ...
            SizedBox(height: 16.0),
            Text('PHONE NUMBER:',style: TextStyle(color: Colors.purple.shade300)),
            _isEditing
                ? TextField(
